...
<div class="col-12 col-sm-10 col-md-5 col-lg-5">
  ...
  <div class="brand-socials my-3 mt-4">
    ...
    <a href="#" class="mx-2"> <i class="bi bi-tiktok"></i></a>
    <a href="https://www.instagram.com/beezzlyy?igsh=MjM0N2Q2NDBjYg==" class="mx-2"> <i class="bi bi-instagram"></i></a>
    <a href="https://x.com/beezzlyyy?s=20" class="mx-2"> <i class="bi bi-twitter"></i></a>
  </div>
</div>
<div class="col-12 col-md-7 col-lg-7">
  <div class="row gy-5">
    ...
    <div class="col-6 col-sm-5 col-lg-3">
      ...
      <div class="row gy-2 mt-2">
        <div><a href="mailto: beezzlyy@outlook.com">beezzlyy@outlook.com</a></div>
      </div>
    </div>
